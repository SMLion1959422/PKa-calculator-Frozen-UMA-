...
bundle = joblib.load("models/model_core_v11.pkl")
...
d = pd.DataFrame(rows)
d.to_csv("characterization_external_v11.csv", index=False)

print(f"\n=== v11: full site-consistent training (n={len(d)}) ===")
...
print("\nsaved -> characterization_external_v11.csv")
