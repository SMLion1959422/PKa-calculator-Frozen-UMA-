...
bundle = joblib.load("models/model_core_v14.pkl")
...
d = pd.DataFrame(rows)
d.to_csv("characterization_external_v14.csv", index=False)

print(f"\n=== v14: + hunt_et_al data (n={len(d)}) ===")
...
print("\nsaved -> characterization_external_v14.csv")
