...
bundle = joblib.load("models/model_core_v10_matched.pkl")
...
d = pd.DataFrame(rows)
d.to_csv("characterization_external_v10.csv", index=False)

print(f"\n=== v10: MATCHED-SITE training + Marvin sites (n={len(d)}) ===")
...
print("\nsaved -> characterization_external_v10.csv")
